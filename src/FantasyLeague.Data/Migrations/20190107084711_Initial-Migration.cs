        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchdayStatus = table.Column<int>(nullable: false),
                    TransferWindowStatus = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavouriteTeamId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchdayId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fixtures_Matchdays_MatchdayId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWiner = table.Column<bool>(nullable: true),
                    PlayedMinutes = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RostersPlayers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RostersPlayers_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RostersPlayers_Rosters_RosterId",
                        column: x => x.RosterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RostersPlayers_PlayerId",
                table: "RostersPlayers",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_RostersPlayers_RosterId",
                table: "RostersPlayers",
                column: "RosterId");
